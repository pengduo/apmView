...
function showJTopoToobar(stage) {
    var toobarDiv = $('<div class="jtopo_toolbar">').html(''
        ...
        + '&nbsp;<input type="radio" name="modeRadio" value="drag" id="r3"/><label for="r3" style="color: #fdfdfd"> 平移</label>'
        + '&nbsp;<input type="radio" name="modeRadio" value="edit" id="r4"/><label for="r4" style="color: #fdfdfd"> 编辑</label>'
